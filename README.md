...
botc/1.0.4 win32-x64 node-v9.4.0
$ botc --help [COMMAND]
USAGE
  $ botc COMMAND
...
...
_See code: [src/commands/build.ts](https://github.com/bot-compiler/botc/blob/v1.0.4/src/commands/build.ts)_
...
_See code: [src/commands/init.ts](https://github.com/bot-compiler/botc/blob/v1.0.4/src/commands/init.ts)_
...
_See code: [src/commands/rebuild.ts](https://github.com/bot-compiler/botc/blob/v1.0.4/src/commands/rebuild.ts)_
<!-- commandsstop -->
* [botc init]
* [botc build]
* [botc rebuild]
